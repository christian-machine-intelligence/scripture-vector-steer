...
set RESIDUAL_VECTOR=%REPO%\results\cardinal_virtue_geometry\cardinal_v1_residual_vectors.pt
...
"%PYTHON%" -X faulthandler -u scripts\build_cardinal_residual_vectors.py ^
  --vectors "%SOURCE_VECTOR%" ^
  --output "%RESIDUAL_VECTOR%" ^
  > results\cardinal_virtue_geometry\cardinal_v1_residual_vectors_build.log 2>&1

if errorlevel 1 exit /b 1

call :run_alpha 3p0 3.0
...
call :run_one prudence prudence_scripture cardinal_v1_residual_alpha%ALABEL%_ratio_l20_prudence_v1 %ALPHA%
call :run_one justice justice_scripture cardinal_v1_residual_alpha%ALABEL%_ratio_l20_justice_v1 %ALPHA%
call :run_one courage fortitude_scripture cardinal_v1_residual_alpha%ALABEL%_ratio_l20_fortitude_v1 %ALPHA%
call :run_one temperance temperance_scripture cardinal_v1_residual_alpha%ALABEL%_ratio_l20_temperance_v1 %ALPHA%
exit /b 0
