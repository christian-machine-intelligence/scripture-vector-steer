...
set VECTOR=%REPO%\results\cardinal_v1_direct_scripture_dual_contrast_fixed_l31_extract_v1_vectors.pt
...
call :run_one prudence prudence_scripture cardinal_v1_direct_dual_alpha6p0_ratio_l20_prudence_v1 6.0
if errorlevel 1 exit /b 1
call :run_one justice justice_scripture cardinal_v1_direct_dual_alpha6p0_ratio_l20_justice_v1 6.0
if errorlevel 1 exit /b 1
call :run_one courage fortitude_scripture cardinal_v1_direct_dual_alpha6p0_ratio_l20_fortitude_v1 6.0
if errorlevel 1 exit /b 1
call :run_one temperance temperance_scripture cardinal_v1_direct_dual_alpha6p0_ratio_l20_temperance_v1 6.0
if errorlevel 1 exit /b 1
