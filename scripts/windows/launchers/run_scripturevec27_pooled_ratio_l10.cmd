...
set PREFIX=scripturevec27_qwen35_27b_pooled_ratio_l10_v1
...
set VIRTUE_BENCH_HF_DEVICE_MAP=auto
set VIRTUE_BENCH_HF_MAX_MEMORY=0:22GiB,1:7GiB
set VIRTUE_BENCH_HF_DOWNLOAD_WORKERS=1
...
"%PYTHON%" -X faulthandler -u -m virtue_bench.cli iconoclast ^
  ...
  --output-prefix experiments/scripturevec27/%PREFIX% ^
