...
REM ============================================================
REM  Disjoint-slice retest, cell L30 / runtime alpha 96
REM  (paper §5.2 "broadest rescue" cell)
REM
...
REM ---- Python: prefer in-repo .venv, fall back to canonical path ----
...
REM ---- Qwen3-14B local checkout (overridable with MODEL_PATH) ----
if not defined MODEL_PATH set MODEL_PATH=C:\Users\sethcodex\models\Qwen3-14B

REM ---- Chapter corpus from the original chapter-confirmation runs ----
...
REM ---- 16 confirmed chapter targets (paper §4.4 survivors) ----
...
set CENTER_LAYER=30
set RUNTIME_ALPHA=96.0

set PREFIX=scripturevec14_qwen3_14b_disjoint_l40_o40_L%CENTER_LAYER%_a96_v1
