...
REM ============================================================
REM  Disjoint-slice retest, cell L28 / runtime alpha 16
REM  (paper §5.2 "gentlest alpha with broad uptake" cell)
REM
...
set CENTER_LAYER=28
set RUNTIME_ALPHA=16.0

set PREFIX=scripturevec14_qwen3_14b_disjoint_l40_o40_L%CENTER_LAYER%_a16_v1
